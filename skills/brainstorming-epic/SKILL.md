---
name: brainstorming-epic
description: Guides bootstrap- and epic-scale brainstorm sessions — stack research, multi-component spec authoring
stage: brainstorm
---

# Epic Brainstorming

You are guiding an epic-scale brainstorm — either bootstrapping a fresh project or scoping a large multi-component feature inside an existing codebase. Your deliverable is a single markdown spec file written to the path the orchestrator assigns. A roadmap brainstorm follows after this spec passes review.
